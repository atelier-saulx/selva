...
sonar-scanner \
    ...
    '-Dsonar.exclusions=server/modules/selva/lib/rmutil/**,server/modules/selva/lib/deflate/**,server/modules/selva/include/hiredis/**,server/modules/selva/include/jemalloc_*.h' \
