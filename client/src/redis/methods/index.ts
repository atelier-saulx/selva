...
async selva_hierarchy_addconstraint(opts: ServerSelector, ...args: args): Promise<any>
...
async selva_hierarchy_addconstraint(opts: any, ...args: args): Promise<any> {
  if (typeof opts === 'object') {
    return new Promise((resolve, reject) => {
      this.addCommandToQueue({ command: 'selva_hierarchy_addconstraint', args, resolve, reject }, opts)
    })
  } else {
    return new Promise((resolve, reject) => {
      this.addCommandToQueue({ command: 'selva_hierarchy_addconstraint', args: [opts, ...args], resolve, reject })
    })
  }
}


async selva_hierarchy_listconstraints(opts: ServerSelector, ...args: args): Promise<any>
async selva_hierarchy_listconstraints(...args: args): Promise<any>
async selva_hierarchy_listconstraints(opts: any, ...args: args): Promise<any> {
  if (typeof opts === 'object') {
    return new Promise((resolve, reject) => {
      this.addCommandToQueue({ command: 'selva_hierarchy_listconstraints', args, resolve, reject }, opts)
    })
  } else {
    return new Promise((resolve, reject) => {
      this.addCommandToQueue({ command: 'selva_hierarchy_listconstraints', args: [opts, ...args], resolve, reject })
    })
  }
}
...
async selva_hierarchy_edgegetmetadata(opts: ServerSelector, ...args: args): Promise<any>
async selva_hierarchy_edgegetmetadata(...args: args): Promise<any>
async selva_hierarchy_edgegetmetadata(opts: any, ...args: args): Promise<any> {
  if (typeof opts === 'object') {
    return new Promise((resolve, reject) => {
      this.addCommandToQueue({ command: 'selva_hierarchy_edgegetmetadata', args, resolve, reject }, opts)
    })
  } else {
    return new Promise((resolve, reject) => {
      this.addCommandToQueue({ command: 'selva_hierarchy_edgegetmetadata', args: [opts, ...args], resolve, reject })
    })
  }
}
...
async selva_update(opts: any, ...args: args): Promise<any> {
  if (typeof opts === 'object') {
    return new Promise((resolve, reject) => {
      this.addCommandToQueue({ command: 'selva_update', args, resolve, reject }, opts)
    })
  } else {
    return new Promise((resolve, reject) => {
      this.addCommandToQueue({ command: 'selva_update', args: [opts, ...args], resolve, reject })
    })
  }
}
...
async selva_subscriptions_delmarker(opts: ServerSelector, ...args: args): Promise<any>
...
async selva_subscriptions_delmarker(opts: any, ...args: args): Promise<any> {
  if (typeof opts === 'object') {
    return new Promise((resolve, reject) => {
      this.addCommandToQueue({ command: 'selva_subscriptions_delmarker', args, resolve, reject }, opts)
    })
  } else {
    return new Promise((resolve, reject) => {
      this.addCommandToQueue({ command: 'selva_subscriptions_delmarker', args: [opts, ...args], resolve, reject })
    })
  }
}
