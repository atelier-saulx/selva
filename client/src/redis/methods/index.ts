...
abstract class RedisMethods {
  ...
  async selva_hierarchy_findin(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_findin', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_findin',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_subscriptions_addmarkerfields(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_subscriptions_addmarkerfields(
    ...
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          {
            command: 'selva_subscriptions_addmarkerfields',
            args,
            resolve,
            reject,
          },
