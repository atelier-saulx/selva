...
async georadiusbymember(opts: any, ...args: args): Promise<any> {
  if (typeof opts === 'object') {
    ...
    return new Promise((resolve, reject) => {
      this.addCommandToQueue('georadiusbymember', [opts, ...args], resolve, reject)
    })
  }
}
...
async zrangebyscore(opts: any, ...args: args): Promise<any> {
  if (typeof opts === 'object') {
    ...
    return new Promise((resolve, reject) => {
      this.addCommandToQueue('zrangebyscore', [opts, ...args], resolve, reject)
    })
  }
}
...
async zremrangebylex(opts: any, ...args: args): Promise<any> {
  if (typeof opts === 'object') {
    ...
    return new Promise((resolve, reject) => {
      this.addCommandToQueue('zremrangebylex', [opts, ...args], resolve, reject)
    })
  }
}
...
async zremrangebyrank(opts: any, ...args: args): Promise<any> {
  if (typeof opts === 'object') {
    ...
    return new Promise((resolve, reject) => {
      this.addCommandToQueue('zremrangebyrank', [opts, ...args], resolve, reject)
    })
  }
}
...
async zremrangebyscore(opts: any, ...args: args): Promise<any> {
  if (typeof opts === 'object') {
    ...
    return new Promise((resolve, reject) => {
      this.addCommandToQueue('zremrangebyscore', [opts, ...args], resolve, reject)
    })
  }
}
...
async zrevrangebylex(opts: any, ...args: args): Promise<any> {
  if (typeof opts === 'object') {
    ...
    return new Promise((resolve, reject) => {
      this.addCommandToQueue('zrevrangebylex', [opts, ...args], resolve, reject)
    })
  }
}
...
async zrevrangebyscore(opts: any, ...args: args): Promise<any> {
  if (typeof opts === 'object') {
    ...
    return new Promise((resolve, reject) => {
      this.addCommandToQueue('zrevrangebyscore', [opts, ...args], resolve, reject)
    })
  }
}
