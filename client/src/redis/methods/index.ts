...
abstract class RedisMethods {
    ...
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        ...
        this.addCommandToQueue(
          { command: <string>key, args: commandArgs, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async multi(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'multi', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async batch(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'batch', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async select(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'select', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async monitor(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'monitor', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async client(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'client', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async hmset(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'hmset', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async subscribe(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'subscribe', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async unsubscribe(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'unsubscribe', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async psubscribe(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'psubscribe', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async punsubscribe(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'punsubscribe', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async append(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'append', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async asking(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'asking', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async bgrewriteaof(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'bgrewriteaof', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async bgsave(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'bgsave', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async bitcount(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'bitcount', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async bitfield(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'bitfield', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async bitfield_ro(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'bitfield_ro', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async bitop(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'bitop', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async bitpos(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'bitpos', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async blmove(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'blmove', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async blpop(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'blpop', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async brpop(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'brpop', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async brpoplpush(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'brpoplpush', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async bzpopmax(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'bzpopmax', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async bzpopmin(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'bzpopmin', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async cluster(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'cluster', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async config(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'config', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async dbsize(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'dbsize', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async debug(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'debug', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async decrby(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'decrby', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async discard(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'discard', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async evalsha(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'evalsha', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async exists(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'exists', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async expire(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'expire', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async expireat(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'expireat', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async failover(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'failover', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async flushall(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'flushall', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async flushdb(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'flushdb', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async geoadd(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'geoadd', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async geodist(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'geodist', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async geohash(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'geohash', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async geopos(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'geopos', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async georadius(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'georadius', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async georadius_ro(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'georadius_ro', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async georadiusbymember(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'georadiusbymember', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async georadiusbymember_ro(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'georadiusbymember_ro', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async geosearch(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'geosearch', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async geosearchstore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'geosearchstore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async getbit(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'getbit', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async getdel(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'getdel', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async getex(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'getex', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async getrange(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'getrange', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async getset(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'getset', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async hello(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'hello', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async hexists(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'hexists', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async hgetall(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'hgetall', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async hincrby(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'hincrby', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async hincrbyfloat(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'hincrbyfloat', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async hkeys(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'hkeys', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async hmget(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'hmget', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async host_(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'host_', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async hrandfield(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'hrandfield', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async hscan(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'hscan', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async hsetnx(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'hsetnx', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async hstrlen(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'hstrlen', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async hvals(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'hvals', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async incrby(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'incrby', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async incrbyfloat(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'incrbyfloat', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async lastsave(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'lastsave', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async latency(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'latency', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async lindex(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'lindex', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async linsert(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'linsert', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async lmove(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'lmove', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async lolwut(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'lolwut', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async lpush(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'lpush', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async lpushx(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'lpushx', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async lrange(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'lrange', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async ltrim(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'ltrim', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async memory(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'memory', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async migrate(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'migrate', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async module(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'module', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async msetnx(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'msetnx', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async object(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'object', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async persist(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'persist', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async pexpire(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'pexpire', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async pexpireat(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'pexpireat', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async pfadd(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'pfadd', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async pfcount(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'pfcount', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async pfdebug(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'pfdebug', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async pfmerge(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'pfmerge', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async pfselftest(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'pfselftest', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async psetex(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'psetex', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async psync(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'psync', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async publish(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'publish', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async pubsub(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'pubsub', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async randomkey(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'randomkey', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async readonly(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'readonly', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async readwrite(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'readwrite', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async rename(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'rename', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async renamenx(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'renamenx', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async replconf(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'replconf', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async replicaof(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'replicaof', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async reset(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'reset', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async restore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'restore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async restore_asking(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'restore_asking', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async rpoplpush(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'rpoplpush', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async rpush(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'rpush', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async rpushx(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'rpushx', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async scard(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'scard', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async script(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'script', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async sdiff(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'sdiff', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async sdiffstore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'sdiffstore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async setbit(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'setbit', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async setex(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'setex', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async setnx(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'setnx', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async setrange(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'setrange', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async shutdown(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'shutdown', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async sinter(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'sinter', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async sinterstore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'sinterstore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async sismember(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'sismember', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async slaveof(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'slaveof', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async slowlog(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'slowlog', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async smembers(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'smembers', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async smismember(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'smismember', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async smove(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'smove', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async srandmember(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'srandmember', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async sscan(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'sscan', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async stralgo(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'stralgo', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async strlen(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'strlen', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async substr(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'substr', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async sunion(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'sunion', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async sunionstore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'sunionstore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async swapdb(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'swapdb', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async touch(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'touch', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async unlink(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'unlink', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async unwatch(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'unwatch', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async watch(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'watch', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async xautoclaim(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'xautoclaim', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async xclaim(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'xclaim', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async xgroup(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'xgroup', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async xinfo(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'xinfo', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async xpending(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'xpending', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async xrange(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'xrange', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async xread(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'xread', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async xreadgroup(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'xreadgroup', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async xrevrange(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'xrevrange', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async xsetid(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'xsetid', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async xtrim(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'xtrim', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zcard(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zcard', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zcount(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zcount', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zdiff(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zdiff', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zdiffstore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zdiffstore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zincrby(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zincrby', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zinter(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zinter', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zinterstore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zinterstore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zlexcount(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zlexcount', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zmscore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zmscore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zpopmax(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zpopmax', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zpopmin(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zpopmin', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zrandmember(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zrandmember', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zrange(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zrange', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zrangebylex(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zrangebylex', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zrangebyscore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zrangebyscore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zrangestore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zrangestore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zrank(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zrank', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zremrangebylex(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zremrangebylex', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zremrangebyrank(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zremrangebyrank', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zremrangebyscore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zremrangebyscore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zrevrange(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zrevrange', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zrevrangebylex(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zrevrangebylex', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zrevrangebyscore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zrevrangebyscore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zrevrank(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zrevrank', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zscan(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zscan', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zscore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zscore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zunion(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zunion', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async zunionstore(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'zunionstore', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_hierarchy_addconstraint(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  async selva_hierarchy_addconstraint(...args: args): Promise<any>
  async selva_hierarchy_addconstraint(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_addconstraint', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_addconstraint',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_listconstraints(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  async selva_hierarchy_listconstraints(...args: args): Promise<any>
  async selva_hierarchy_listconstraints(
    opts: any,
    ...args: args
  ): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_listconstraints', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_listconstraints',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_aggregate(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_hierarchy_aggregate(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_aggregate', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_aggregate',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_aggregatein(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_hierarchy_aggregatein(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_aggregatein', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_aggregatein',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_children(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_hierarchy_children(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_children', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_children',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_del(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_del', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_hierarchy_edgeget(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_edgeget', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_edgeget',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_edgegetmetadata(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  async selva_hierarchy_edgegetmetadata(...args: args): Promise<any>
  async selva_hierarchy_edgegetmetadata(
    opts: any,
    ...args: args
  ): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_edgegetmetadata', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_edgegetmetadata',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_edgelist(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_hierarchy_edgelist(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_edgelist', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_edgelist',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_find(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_find', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_hierarchy_parents(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_parents', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_parents',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_compress(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_hierarchy_compress(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_compress', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_compress',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_listcompressed(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_hierarchy_listcompressed(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_listcompressed', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_listcompressed',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_types_add(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_hierarchy_types_add(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_types_add', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_types_add',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_types_clear(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_hierarchy_types_clear(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_types_clear', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_types_clear',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_types_list(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_hierarchy_types_list(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_types_list', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_hierarchy_types_list',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_hierarchy_ver(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_hierarchy_ver', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_inherit(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_inherit', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_modify(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_modify', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_update(opts: ServerSelector, ...args: args): Promise<any>
  async selva_update(...args: args): Promise<any>
  async selva_update(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_update', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_resolve_nodeid(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_resolve_nodeid', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_object_del(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_object_del', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_object_exists(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_object_exists', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_object_get(opts: any, ...args: args): Promise<any> {
    const fn =
      typeof opts === 'object'
        ? (resolve, reject) => {
            this.addCommandToQueue(
              { command: 'selva_object_get', args, resolve, reject },
              opts
            )
          }
        : (resolve, reject) => {
            this.addCommandToQueue({
              command: 'selva_object_get',
              args: [opts, ...args],
              resolve,
              reject,
            })
    ...
    if (typeof res === 'string' && /�/.test(res)) {
      // retry it once (don't go in a loop)
      res = await new Promise(fn)
    }
    return res
  }
  ...
  async selva_object_len(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_object_len', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_object_set(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_object_set', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_object_type(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_object_type', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_object_getmeta(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_object_getmeta', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_object_setmeta(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_object_setmeta', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_subscriptions_add(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_subscriptions_add', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_subscriptions_add',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_subscriptions_addalias(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_subscriptions_addalias(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_subscriptions_addalias', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_subscriptions_addalias',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_subscriptions_addmissing(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_subscriptions_addmissing(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_subscriptions_addmissing', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_subscriptions_addmissing',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_subscriptions_addtrigger(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_subscriptions_addtrigger(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_subscriptions_addtrigger', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_subscriptions_addtrigger',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_subscriptions_debug(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_subscriptions_debug(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_subscriptions_debug', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_subscriptions_debug',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_subscriptions_del(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_subscriptions_del', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_subscriptions_del',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_subscriptions_delmarker(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  async selva_subscriptions_delmarker(...args: args): Promise<any>
  async selva_subscriptions_delmarker(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_subscriptions_delmarker', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_subscriptions_delmarker',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_subscriptions_list(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_subscriptions_list(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_subscriptions_list', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_subscriptions_list',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_subscriptions_listmissing(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_subscriptions_listmissing(
    ...
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_subscriptions_listmissing', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_subscriptions_listmissing',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_subscriptions_refresh(
    opts: ServerSelector,
    ...args: args
  ): Promise<any>
  ...
  async selva_subscriptions_refresh(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_subscriptions_refresh', args, resolve, reject },
          opts
        )
      })
    } else {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue({
          command: 'selva_subscriptions_refresh',
          args: [opts, ...args],
          resolve,
          reject,
        })
  ...
  async selva_index_list(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_index_list', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_index_new(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_index_new', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_index_del(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_index_del', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_rpn_evalbool(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_rpn_evalbool', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_rpn_evaldouble(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_rpn_evaldouble', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_rpn_evalstring(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_rpn_evalstring', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_log_dbg(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_log_dbg', args, resolve, reject },
          opts
        )
      })
    } else {
  ...
  async selva_log_dbglist(opts: any, ...args: args): Promise<any> {
    if (typeof opts === 'object') {
      return new Promise((resolve, reject) => {
        this.addCommandToQueue(
          { command: 'selva_log_dbglist', args, resolve, reject },
          opts
        )
      })
    } else {
